...
xit("line: 48 - matches (Ab|cD)* against 'aBcD'", () => {
...
it("line: 73 - matches abaa|abbaa|abbbaa|abbbbaa against 'ababbabbbabbbabbbbabbbbaa'", () => {
  const match = exec("abaa|abbaa|abbbaa|abbbbaa", "ababbabbbabbbabbbbabbbbaa");
...
it("line: 75 - matches aaac|aabc|abac|abbc|baac|babc|bbac|bbbc against 'baaabbbabac'", () => {
  const match = exec("aaac|aabc|abac|abbc|baac|babc|bbac|bbbc", "baaabbbabac");
